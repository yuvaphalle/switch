...
export class Web3Storage implements Service {
     ...
     */
    static put({ endpoint, token }: Service, files: Iterable<Filelike>, { onRootCidReady, onStoredChunk, maxRetries, maxChunkSize, wrapWithDirectory, name }?: import("./lib/interface.js").PutOptions | undefined): Promise<CIDString>;
    /**
     * @param {Service} service
     ...
     * @returns {Promise<CIDString>}
     */
    static putCar({ endpoint, token }: Service, car: import('@ipld/car/api').CarReader, { name, onStoredChunk, maxRetries, maxChunkSize, decoders }?: import("./lib/interface.js").PutCarOptions | undefined): Promise<CIDString>;
    /**
     * @param {Service} service
     * @param {CIDString} cid
